 ...
 */
 ...
 public class Account {
     ...
     public Account(String ownerName, int accountNumber, double balance) {
         ...
         this.transactionHistory.add("Account created with balance: $" + String.format("%.2f", balance));
     }
     ...
     public void setAccountBalance(double accountBalance) {
         ...
         transactionHistory.add("Account balance updated to: $" + String.format("%.2f", accountBalance));
     }
     ...
     public void deposit(double amount) {
         if (amount > 0) {
             ...
             transactionHistory.add("Failed deposit attempt: Invalid amount " + String.format("%.2f", amount));
         }
     }
     ...
     public void withdraw(double amount) {
         if (amount > 0 && amount <= accountBalance) {
             ...
             transactionHistory.add("Failed withdrawal attempt: Invalid amount " + String.format("%.2f", amount));
         }
     }
